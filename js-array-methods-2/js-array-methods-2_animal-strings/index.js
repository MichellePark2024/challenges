...
const firstAnimalStartingWithLetterP = animalStrings.find((animalString) => animalString.startsWith("p")) 
...
const anyAnimalEndsWithLetterZ = animalStrings.some((animalString) => animalString.endsWith("z")) ;
console.log(anyAnimalEndsWithLetterZ)


const everyAnimalHasMoreThanTwoLetters = animalStrings.every((animalString) => animalString.length > 2);
