...
// const response = fetch(colorApiUrl)  or :
// try {
// const data = await fetch(colorApiUrl).then((res)=>res.json())
// console.log(data)
// return data;

// setColorToGuess(data.name.closest_name_hex, data.name.value)
// } catch(error) {
//   console.error(error)
// }
  ...
  setColorToGuess(closestHex, name);
}
